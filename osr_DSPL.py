...
# parser.add_argument('--centroid_path', type=str, default='./Estimated_prototypes/6centers_128dim.pth')
# parser.add_argument('--centroid_path', type=str, default='./Estimated_prototypes/4centers_128dim.pth')
parser.add_argument('--centroid_path', type=str, default='./Estimated_prototypes/20centers_128dim.pth')
...
parser.add_argument('--loss', type=str, default='MARLoss_match')
...
if __name__ == '__main__':
    ...
    for i in range(len(splits[options['dataset']])):
        ...
        if options['dataset'] == 'cifar100':
            file_name = '{}_{}_{}.csv'.format(options['dataset'], options['out_num'], time_str)
        else:
